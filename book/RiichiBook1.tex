...
% FIXME: direct reference to dvipdfmx fails when building with lualatex
% Seems fine without it. Assess impact ?
...
{\LARGE Introduction à la stratégie au mahjong\\pour joueurs européens}
\end{spacing}
